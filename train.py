...
def train_and_test_AUC(model, train_loader, test_loader, num_epochs,lr,sigma):
    ...
    return F1_score,AUC_score,ECE_score

if __name__ == '__main__':
    train_loader, test_loader = process_clintox(False)
    ...
    with open('training_results.txt', 'w') as result_file:
        ...
        for run in range(5):  # Randomly run five times.
            ...
            F1, AUC, ECE= train_and_test_AUC(model, train_loader, test_loader, 100, lr=lr,sigma=sigma)
            f1_scores.append(F1)
